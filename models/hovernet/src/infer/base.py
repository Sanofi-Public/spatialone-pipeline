...
from src.run_utils.utils import convert_pytorch_checkpoint
...
class InferManager(object):
    ...
    def __load_model(self):
        ...
        """
        model_desc = import_module("src.models.hovernet.net_desc")
        ...
        module_lib = import_module("src.models.hovernet.run_desc")
        run_step = getattr(module_lib, "infer_step")
        self.run_step = lambda input_batch: run_step(input_batch, net)

        module_lib = import_module("src.models.hovernet.post_proc")
    ...
    def __save_json(self, path, old_dict, mag=None):
        ...
        Args:
            ...
            old_dict (_type_): _description_
            mag (_type_, optional): _description_. Defaults to None.
