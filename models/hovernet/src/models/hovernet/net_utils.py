...
class DenseBlock(Net):
    ...
    def __init__(self, in_ch, unit_ksize, unit_ch, unit_count, split=1):
        ...
        Args:
            in_ch (_type_): _description_
            unit_ksize (_type_): _description_
            unit_ch (_type_): _description_
            unit_count (_type_): _description_
            split (int, optional): _description_. Defaults to 1.
        """
    ...
    def forward(self, prev_feat):
        ...
        Args:
            prev_feat (_type_): _description_
