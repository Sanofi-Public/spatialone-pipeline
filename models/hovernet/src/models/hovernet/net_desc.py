...
class HoVerNet(Net):
    ...
    def __init__(self, input_ch=3, nr_types=None, freeze=False, mode="original"):
        ...
        Args:
            ...
            nr_types (_type_, optional): _description_. Defaults to None.
            freeze (bool, optional): _description_. Defaults to False.
            mode (str, optional): _description_. Defaults to "original".
        ...
        def create_decoder_branch(out_ch=2, ksize=5):
            ...
            Args:
                out_ch (int, optional): _description_. Defaults to 2.
