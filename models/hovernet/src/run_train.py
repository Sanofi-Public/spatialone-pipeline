...
from run_utils.utils import (  # check_log_dir,
    check_manual_seed,
    colored,
...
class TrainManager(Config):
    ...
    def _get_datagen(self, batch_size, run_mode, target_gen, nr_procs=0, fold_idx=0):
        ...
        Args:
            ...
            run_mode (_type_): _description_
            target_gen (_type_): _description_
            nr_procs (int, optional): _description_. Defaults to 0.
            fold_idx (int, optional): _description_. Defaults to 0.
    ...
    def run_once(self, opt, run_engine_opt, log_dir, prev_log_dir=None, fold_idx=0):
        ...
        def get_last_chkpt_path(prev_phase_dir, net_name):
            ...
            Args:
                prev_phase_dir (_type_): _description_
