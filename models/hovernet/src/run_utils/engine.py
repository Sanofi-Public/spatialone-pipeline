...
class RunEngine(object):
    ...
    def __init__(
        ...
        Args:
            engine_name (_type_, optional): _description_. Defaults to None.
            dataloader (_type_, optional): _description_. Defaults to None.
            run_step (_type_, optional): _description_. Defaults to None.
            run_info (_type_, optional): _description_. Defaults to None.
            log_info (_type_, optional): _description_. Defaults to None.
        """
    ...
    def run(self, nr_epoch=1, shared_state=None, chained=False):
        ...
        Args:
            nr_epoch (int, optional): _description_. Defaults to 1.
            shared_state (_type_, optional): _description_. Defaults to None.
            chained (bool, optional): _description_. Defaults to False.
        """
        # TODO: refactor this
        if chained:
