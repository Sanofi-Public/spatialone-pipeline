...
class Config(object):
    ...
    def __init__(self):
        ...
        self.dataset_name = "lymphocytes"  # extracts dataset info from dataset.py
        self.log_dir = "../cache/hovernet_logs"  # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            "../cache/dataset/training_data/lymphocytes/train/540x540_164x164/"
        ]
        self.valid_dir_list = [
            "../cache/dataset/training_data/lymphocytes/val/540x540_164x164/"
        ]
