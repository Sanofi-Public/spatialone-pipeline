...
def run_nuclei_type_stat(pred_dir, true_dir, type_uid_list=None, exhaustive=True):
    ...
    def _f1_type(paired_true, paired_pred, unpaired_true, unpaired_pred, type_id, w):
        ...
        Args:
            paired_true (_type_): _description_
            paired_pred (_type_): _description_
            unpaired_true (_type_): _description_
            unpaired_pred (_type_): _description_
            type_id (_type_): _description_
...
def run_nuclei_inst_stat(pred_dir, true_dir, print_img_stats=False, ext=".mat"):
    ...
    Args:
        pred_dir (_type_): _description_
        true_dir (_type_): _description_
        print_img_stats (bool, optional): _description_. Defaults to False.
        ext (str, optional): _description_. Defaults to ".mat".
