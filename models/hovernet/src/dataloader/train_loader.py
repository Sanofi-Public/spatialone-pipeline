...
class FileLoader(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            mask_shape (_type_, optional): _description_. Defaults to None.
            mode (str, optional): _description_. Defaults to "train".
            setup_augmentor (bool, optional): _description_. Defaults to True.
            target_gen (_type_, optional): _description_. Defaults to None.
        """
